...
|---|---|---|
| **Vishaal** | Team Lead | ML pipeline scope, statistical accuracy, GitHub management |
...
| **Ishitha** | Frontend Developer | Structural layout design schemas, UI styling, formal presentation materials |
