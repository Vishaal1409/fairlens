...
|---|---|---|
| **Vishaal** | Team Lead | Backend ML pipeline scope, statistical accuracy, GitHub management |
...
| **Ishitha** | UI/UX Designer | Structural layout design schemas, UI styling, formal presentation materials |
